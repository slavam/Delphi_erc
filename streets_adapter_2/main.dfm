object MainForm: TMainForm
  Left = 0
  Top = 0
  Caption = #1057#1086#1087#1086#1089#1090#1072#1074#1083#1077#1085#1080#1077' '#1089#1087#1088#1072#1074#1086#1095#1085#1080#1082#1086#1074' '#1091#1083#1080#1094
  ClientHeight = 426
  ClientWidth = 655
  Color = clBtnFace
  ...
  object CBStreetTemplates: TComboBox
    Left = 184
    Top = 27
    Width = 169
    Height = 21
    ...
    TabOrder = 10
    Text = 'CBCity'
    OnSelect = CBStreetTemplatesSelect
  end
  object BDisposition: TButton
    Left = 376
    Top = 391
    Width = 121
    Height = 25
    Caption = #1057#1086#1079#1076#1072#1090#1100' '#1076#1080#1089#1087#1086#1079#1080#1094#1080#1102
    TabOrder = 11
    OnClick = BDispositionClick
  end
