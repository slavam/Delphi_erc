...
begin
  ...
  get_address_params_by_bankbook(address_params, ADOQ, Inttostr(bankbook_params.code_firm),
  ...
  get_payer_options_by_bankbook(payer_params, ADOQ, IntToStr(current_period_id),
    bankbook_params.id);
